...
module.exports = HandleMsg = async (pakforlay, message) => {
	...
	// Filter Banned People
            ...
            if (isOwnerBot) {
                await pakforlay.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await pakforlay.sendText(chekgrup.id, `Hai minna~, Im Popox BOT. To find out the commands on this bot type ${prefix}menu`)
                      })
            } else {
        ...
        case 'insta':
            ...
            await pakforlay.sendFileFromUrl(from, instag, 'Sukses mengunduh Foto/Video Instagram Menggunakan Bot WhatsApp Popox', '', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
		case 'tiktok':
            ...
            await pakforlay.sendFileFromUrl(from, tiktok, `Sukses mengunduh Video Tiktok tanpa Watermark Menggunakan Bot WhatsApp Popox`, id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
        case 'ytmus':
            ...
            await pakforlay.sendFileFromUrl(from, ytmus, `Sukses mengunduh MP3 Youtube Menggunakan Bot WhatsApp Popox`, id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
		case 'ytvid':
            ...
            await pakforlay.sendFileFromUrl(from, youtube, `Sukses mengunduh Video Youtube Menggunakan Bot WhatsApp Popox`, id)
            .catch(() => {
